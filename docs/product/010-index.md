...
Второй способ инструментирования — вокруг вызовов методов хранилища сущностей. Наблюдатель видит операции entity, но не видит, из какого метода прикладного хранилища сущностей они пришли; `ОтелИнструментированиеХранилищаСущностей` оборачивает хранилище и дает спан на каждый вызов, а операции и запросы внутри становятся дочерними:
...
Подробности — в [справочнике](../api/ОтелИнструментированиеХранилищаСущностей.md).
...
| Гистограмма | `entity.repository.invocations` | с | `entity.repository`, `code.function.name`, `entity.repository.state`: `success`, `error`, `error.type` |
