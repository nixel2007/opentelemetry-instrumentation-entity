...
Второй способ инструментирования — вокруг вызовов методов хранилища. Наблюдатель видит операции entity, но не видит, из какого метода прикладного хранилища они пришли; `ОтелИнструментированиеХранилища` оборачивает хранилище и дает спан на каждый вызов, а операции и запросы внутри становятся дочерними:
...
Подробности — в [справочнике](../api/ОтелИнструментированиеХранилища.md).
