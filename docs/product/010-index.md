...
Наблюдатель регистрируется на менеджере и видит все, что происходит с его источником данных: операции самого менеджера, его хранилищ сущностей и активной записи, запросы, соединения и транзакции. Зарегистрированный до `Инициализировать` наблюдатель видит и создание таблиц.
