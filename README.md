...
Требует entity 5.4 и OneScript 2.2: контекст исполнения обе библиотеки ведут в данных потока исполнения (`ТекущийПоток`).
...
Вызовы методов хранилищ сущностей инструментируются отдельно — `ОтелИнструментированиеХранилищаСущностей` оборачивает хранилище сущностей и дает спан на каждый вызов:
